...
1. Duijns, S. et al. Foraging site delection of two subspecies of bar-tailed godwit _Limosa lapponica_: time minimizers accept greater predation danger than energy minimizers. Ardea 97, 51–59 (2009). <a id="duijns_2009"></a>



P.S. The html file from this markdown can be recereated with folloing code
```{r eval=FALSE}
download.file('https://git.io/v1SnN', 'tmp.rmd')
