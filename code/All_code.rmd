...
## 3. Refuelling rates and their relationship with lugworm abundance

### 3.1 Estimate yearly arrival mass from Castricum data
```{r}
library(lme4)
if (Use_local_data) {
...
### 3.5 Prepare data and initial values
```{r}
...
### 3.7 Explore and save model results
```{r results='hide'}
...
### 3.8 Plot estimated refuelling slopes by lugworm abundance
...
## 5. Population trends from winter counts in West Africa
...
## 8. Plot capture data with slopes (Extended data Figure 1 and 2)
