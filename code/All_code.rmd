...
Inits<-function() { 
          list(
               ...
               b5.3=runif(1,-1, 1),
               b5.4=runif(1,-1, 1),
               Arr_WZ_sigma=runif(1,0, 10),
               Snowmelt_sigma=runif(1,0, 10),
               Arr_T_sigma=runif(1,0, 10),
               Tipula_sigma=runif(1,0, 10),
               Breeding_sigma=runif(1,0, 10),
               Nests_sigma=runif(1,0, 10))
}
...
## 12. Supplementary Figures 1 and 2
