# Supplementary co code to 'Food abundance at temperate shores can mitigate Arctic climate change effects in a migratory bird' by Rakhimberideb et al. to be submitted

_author Eldar Rakhimberdiev_
...
The html file from this markdown can be recereated with folloing code
```{r eval=FALSE}
download.file('https://git.io/vXaM6', 'tmp.rmd')
render('tmp.rmd', output_format = 'html_document',
